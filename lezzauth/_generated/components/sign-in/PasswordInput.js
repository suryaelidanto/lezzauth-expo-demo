...
function PasswordInput(_a) {
    ...
    const setFieldValue = (_f = (_e = state.signInForm) === null || _e === void 0 ? void 0 : _e.input) === null || _f === void 0 ? void 0 : _f.setFieldValue;
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(react_native_1.View, { children: [(0, jsx_runtime_1.jsx)(react_native_1.TextInput, Object.assign({ id: id || "password", textContentType: 'password', onKeyPress: () => { setFieldTouched && setFieldTouched("password", true); }, onChangeText: (val) => {
                        ...
                        }, secureTextEntry: !showPassword, style: Object.assign({ fontSize: 14, backgroundColor: 'white', borderColor: error ? 'red' : 'gray', borderWidth: 1, borderRadius: 8, padding: 10, marginBottom: error ? 2 : 0 }, react_native_1.StyleSheet.flatten(style || {})) }, props)), (0, jsx_runtime_1.jsx)(react_native_1.TouchableOpacity, { onPress: handleTogglePassword, style: {
                            position: 'absolute',
                            right: 10,
                            top: '50%',
                            transform: [{ translateY: -10 }],
                            zIndex: 1
                        }, children: showPassword ? ((0, jsx_runtime_1.jsx)(vector_icons_1.MaterialCommunityIcons, { name: "eye-off", size: 24, color: "#888" })) : ((0, jsx_runtime_1.jsx)(vector_icons_1.MaterialCommunityIcons, { name: "eye", size: 24, color: "#888" })) })] }), error && (0, jsx_runtime_1.jsx)(InputError_1.InputError, { message: error })] }));
}
