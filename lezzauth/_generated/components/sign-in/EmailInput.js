...
function EmailInput(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(react_native_1.TextInput, Object.assign({ id: id || "email", textContentType: 'emailAddress', onKeyPress: () => { setFieldTouched && setFieldTouched("email", true); }, onChangeText: (val) => {
                ...
                }, style: Object.assign({ fontSize: 14, backgroundColor: 'white', borderColor: error ? 'red' : 'gray', borderWidth: 1, borderRadius: 8, padding: 10, marginBottom: error ? 2 : 0 }, react_native_1.StyleSheet.flatten(style || {})) }, props)), error && (0, jsx_runtime_1.jsx)(InputError_1.InputError, { message: error })] }));
}
